...
const mostrarRespostasCertas = () => {
    ...
    const resposta4 = document.querySelectorAll('input[name="pergunta4"] ~ label')[1].style.color = 'green'
    const resposta5 = document.querySelectorAll('input[name="pergunta5"] ~ label')[3].style.color = 'green'
    ...
    const resposta10 = document.querySelectorAll('input[name="pergunta10"] ~ label')[0].style.color = 'green'
}
